...
```shell
brew install file yazi ffmpegthumbnailer unar jq poppler fd ripgrep fzf zoxide eza glow exiftool bat lazygit lazydocker sevenzip imagemagick font-symbols-only-nerd-font clipboard
